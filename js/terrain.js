...
function draw_terrain()
{
    ...
    //before drawing a terrain we need to generate points everytime
...
function generate_terrain_pts()
{
  ...
  // starting conditions
    var height = (Math.random() * HEIGHT_MAX/2) + (2*HEIGHT_MAX/2);
...
for (var i = 0; i < canvas.width; i++) 
    ...
    if (height > 0.85*HEIGHT_MAX) { 
        height = 0.85*HEIGHT_MAX;
        slope *= -1;
    }
